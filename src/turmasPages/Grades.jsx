...
function Grades() {
    ...
    const handleAddGrade = async (e) => {
        ...
        try {
            ...
            await axios.post(`${getApiUrl()}/Grade/AddGrade`, { name, levelId: parseInt(levelId), level });
            fetchGrades();
            setName('');
            setLevelId('');
        } catch (error) {
    ...
    const renderGradesByLevel = (levelId) => {
        ...
        const levelName = levels.find(level => level.id === levelId)?.name || 'Nível Desconhecido';
